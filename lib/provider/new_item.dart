...
class Item{
  ...
  bool isSale;
  num finalPrice;
  Item({required this.id,required this.finalPrice,required this.image,required this.nameEn,required this.nameAr,
    required this.isSale,required this.price,required this.salePrice,required this.disPer});
}